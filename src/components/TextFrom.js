...
export default function TextFrom(props) {
    ...
    return (
        ...
        <div style={{color : props.mode==='dark' ? 'white' : 'black'}}>
            ...
            <div className="mb-3">
                <textarea style={{backgroundColor : props.mode==='dark' ? 'black' : 'white', color : props.mode==='light' ? 'black' : 'white'}} rows="8" className={`form-control my-3 bg-${props.mode}`} value={text} onChange={handleOnChange} id="myBox"/>
            </div>
